...
##### 8. Create a null distribution of means for men and assign it to the variable `nullM` by setting the seed at 1, and using the sampling arguments from question 4. What is the maximum difference you observe assuming the null hypothesis?

##### 9. Assuming the above null distribution, what is the probability of finding an observed difference of 2 inches between your two groups?
