...
theme_apa <- function(plot.box = FALSE){
  ...
  out <- theme(
    plot.title=element_text(family=RMN, size=24, face="bold", colour="black"),
	panel.margin=unit(50,"cm"),
    axis.title.x=element_text(family=RMN, size=24, face="bold", colour="black", vjust=-0.1),
    axis.title.y=element_text(family=RMN, size=24, angle=90, face="bold", colour="black", vjust=0.5),
