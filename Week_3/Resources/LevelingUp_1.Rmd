...
This is a quick example for using logical statements in R. The main purpose of logical statements is to identify whether a condition is `TRUE` or `FALSE`. For example, lets test whether number 2+2 is equal to 5.
